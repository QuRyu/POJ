...
public: 
    And(unique_ptr<Operator> &&x, unique_ptr<Operator> &&y): x(move(x)), y(move(y)) { }
...
class Or : public Operator {
    ...
    unique_ptr<Operator> y;
public: 
    Or(unique_ptr<Operator> &&x, unique_ptr<Operator> &&y): x(move(x)), y(move(y)) { }
...
class Implies : public Operator {
    ...
    unique_ptr<Operator> y;
public: 
    Implies(unique_ptr<Operator> &&x, unique_ptr<Operator> &&y): x(move(x)), y(move(y)) { }
...
class Equals : public Operator {
    ...
    unique_ptr<Operator> y;
public: 
    Equals(unique_ptr<Operator> &&x, unique_ptr<Operator> &&y): x(move(x)), y(move(y)) { }
...
struct Ret {
    ...
    Ret(unique_ptr<Operator> op, unordered_set<string> vars): op(move(op)), vars(vars), i(0) {}
    Ret(unique_ptr<Operator> op, unordered_set<string> vars, int i): op(move(op)), vars(vars), i(i) {}
    Ret() {}
};


Ret parse_helper(const string &input, int i) {
    assert (i < input.size());
    switch (input[i]) {
        case 'A': {
            Ret ret1 = parse_helper(input, i+1);
            Ret ret2 = parse_helper(input, ret1.i);
            
            ret1.vars.insert(ret2.vars.begin(), ret2.vars.end());
            Ret ret(make_unique<Or>(move(ret1.op), move(ret2.op)), ret1.vars, ret2.i+1);
            return ret;
        }
        ...
        case 'K': {
            ...
            ret1.vars.insert(ret2.vars.begin(), ret2.vars.end());
            Ret ret(make_unique<And>(move(ret1.op), move(ret2.op)), ret1.vars, ret2.i+1);
            return ret;
        }
        ...
        case 'C': {
            ...
            ret1.vars.insert(ret2.vars.begin(), ret2.vars.end());
            Ret ret(make_unique<Implies>(move(ret1.op), move(ret2.op)), ret1.vars, ret2.i+1);
            return ret;
        }
        ...
        case 'E': {
            ...
            ret1.vars.insert(ret2.vars.begin(), ret2.vars.end());
            Ret ret(make_unique<Equals>(move(ret1.op), move(ret2.op)), ret1.vars, ret2.i+1);
            return ret;
        }
        default: {
            Ret ret(make_unique<Var>(string(1, input[i])), {string(1, input[i])}, i+1);
            return ret;
        }
    }
...
Ret parse(const string &input) {
    int i  = 0;
    Ret ret;
    for (; i < input.length(); i++) {
        Ret temp = parse_helper(input, i);
        i = ret.i;

        ret.vars.insert(temp.vars.begin(), temp.vars.end());
        ret.op = move(temp.op);
    }
...
void check_tautology(const Ret &ret) {
    ...
    int i = 0;
    for (unordered_set<string>::iterator it=ret.vars.begin(); it!=ret.vars.end(); it++) {
        var_idx[i++] = *it;
    }
